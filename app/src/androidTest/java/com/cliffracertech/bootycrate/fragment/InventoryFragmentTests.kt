...
class InventoryFragmentTests {
    ...
    @Test fun expandItem() {
        ...
        onView(withId(R.id.inventoryView)).check(onlyExpandedIndexIs(null))

        onView(withId(R.id.inventoryView)).perform(
    ...
    @Test fun emptyMessageAppears() {
        ...
        onView(withId(R.id.inventoryView)).check(matches(not(isDisplayed())))
    }
    ...
    @Test fun emptyMessageDisappears() {
        ...
        onView(emptySearchResultsMessage()).check(matches(not(isDisplayed())))
        onView(withId(R.id.inventoryView)).check(matches(isDisplayed()))
    }
    ...
    @Test fun addToShoppingList() {
        ...
        onView(withId(R.id.changeSortButton)).perform(click())
        onPopupView(withText(R.string.color_description)).perform(click())
        onView(withId(R.id.shoppingListView)).check(onlyShownShoppingListItemsAre(
    ...
    @Test fun changeItemColor() {
        ...
        onView(withId(R.id.inventoryView)).perform(doStuff<RecyclerView> {
            val item = (it.adapter as ListAdapter<*, *>).currentList[2] as InventoryItem
            assertThat(item.color).isEqualTo(6)
            val vh = it.findViewHolderForAdapterPosition(2) as InventoryView.ViewHolder
    ...
    @Test fun changeItemExtraInfo() {
        onView(withId(R.id.inventoryView)).perform(
            ...
            doStuff<RecyclerView> {
                ...
                val vh = it.findViewHolderForAdapterPosition(1) as InventoryView.ViewHolder
    ...
    @Test fun addToShoppingListWorksWhenAmountIsDecreasedBelowTrigger() {
        onView(withId(R.id.inventoryView)).perform(
            actionsOnItemAtPosition(3,
                ...
                clickEditButton()))
        onView(withId(R.id.shoppingListButton)).perform(click())
        val expectedItem = ShoppingListItem(name = grayItem11.name, amount = 3,
