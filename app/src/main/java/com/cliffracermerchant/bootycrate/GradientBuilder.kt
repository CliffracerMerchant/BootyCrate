...
data class GradientBuilder(
    ...
    fun setColors(colors: IntArray) = apply { this.colors = colors }
    fun setStops(stops: FloatArray) = apply { this.stops = stops }
    ...
    fun buildRadialGradient(): RadialGradient {
        if (x2 == y2) return RadialGradient(x1, y1, x2, colors, stops, tileMode)
    ...
    override fun hashCode() = Triple(super.hashCode(), colors.hashCode(), stops).hashCode()
}