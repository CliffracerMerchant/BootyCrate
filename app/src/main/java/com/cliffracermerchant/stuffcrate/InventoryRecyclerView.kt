 ...
 *  attempted. In order to allow it to calculate changes to the displayed data
 *  on a background thread, it implements the Observer<List<InventoryItem>>
 *  interface and contains an AsyncListDiffer member.
